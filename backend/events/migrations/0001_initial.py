    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumnail', models.URLField(blank=True, default='', max_length=100)),
                ('title', models.CharField(max_length=70)),
                ('category', multiselectfield.db.fields.MultiSelectField(choices=[('Conference', 'Conference'), ('Workshop', 'Workshop'), ('Hackathon', 'Hackathon'), ('competition', 'competition'), ('Meeting', 'Meeting'), ('Recruting', 'Recruting')], max_length=59)),
