    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', models.ManyToManyField(blank=True, related_name='_profile_links_+', to='profiles.Profile')),
                ('projects', models.ManyToManyField(blank=True, related_name='_profile_projects_+', to='profiles.Profile')),
