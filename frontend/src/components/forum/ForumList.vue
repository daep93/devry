<template>
  <div>
    <div class="q-pa-md" style="text-align: justify;">
      <div
        class="justify-center"
        style="width: 900px; height: 600px; margin:0 auto; background-color: white;"
      >
        <!-- 탭 시작 -->
        <div class="q-pa-md">
                ...
                <div v-for="n in 5" :key="n">
                  <q-card flat bordered class="my-card" style="width: 800px;">
                    <q-item class="col-align">
                      ...
                      <!-- 프로필 -->
                      <div style="width: 650px; padding-top: 20px;">
                        ...
                        <div class="icon-position">
                          <q-icon
                            ...
                            class="q-mr-sm"
                          ></q-icon>
                          <span style="margin-right: 20px;">17 likes</span>
                          <q-icon
                            ...
                            class="q-mr-sm"
                          ></q-icon>
                          <span style="margin-right: 20px;">2 comments</span>
                        </div>
                        <!-- <span
                          style="display: flex; font-size: 5px; margin-left:50px; margin-top: -10px;"
                          >7시간 전</span
                        > -->
