const colorDict = alpha => {
  return {
    swift: `rgba(234,78,40,${alpha})`,
    flutter: `rgba(86,197,246,${alpha})`,
...
const matchingColorDict = alpha => {
  return {
    swift: '#ffffff',
    flutter: `rgba(43,58,72,${alpha})`,
    angular: '#ffffff',
    django: '#ffffff',
    java: `rgba(1,71,110,${alpha})`,
    vue: `rgba(53,73,94,${alpha})`,
    typescript: '#ffffff',
    docker: `rgba(115,199,230,${alpha})`,
    python: `rgba(255,223,91,${alpha})`,
